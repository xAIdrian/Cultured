...
public class NewsHeaderLayout extends RelativeLayout {
    ...
    private LinearLayout housingLinearLayout;
    ...
    public NewsHeaderLayout(Context context, AttributeSet attrs) {
        ...
        titleText = typedArray.getString(R.styleable.NewsHeaderLayout_titleText);
        dateText = typedArray.getString(R.styleable.NewsHeaderLayout_dateText);
        sectionText = typedArray.getString(R.styleable.NewsHeaderLayout_sectionText);
        gradientDrawable = typedArray.getDrawable(R.styleable.NewsHeaderLayout_gradientDrawable);
